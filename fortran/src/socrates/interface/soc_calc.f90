module soc_calc_mod
  ...
  use socrates_set_spectrum, only: spectrum_array_name, spectrum_array, &
       mcica_spectrum_name, mcica_data_array, set_spectrum
...
contains
  ...
  subroutine soc_calc(n_profile, n_layer, diag, control,dimen, &
  ...
  h2o, ch4, co, co2, nh3, hcn, c2h6, h2, he, o3, n2, &
  p_layer_1d, t_layer_1d, t_level_1d, mass_1d, density_1d, &
  h2o_1d, o3_1d, h2_1d, he_1d, ch4_1d, co_1d, co2_1d, hcn_1d,&
  c2h6_1d, n2_1d, nh3_1d, &
  ...
  l_invert, l_profile_last, l_debug, i_profile_debug)
    ...
    ! if (i_source .eq. ip_source_illuminate) then
    !    write(*,*) 'here'
    !    dimen = dimen_sw
    ! else
    !    dimen = dimen_lw
