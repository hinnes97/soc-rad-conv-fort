...
LOGICAL :: l_planet_grey_surface = .TRUE.
  ...
  LOGICAL :: tidally_locked = .TRUE.!.FALSE.
  ...
  logical :: use_pressure_interp_for_half_levels = .True. !By default (.False.) does linear interpolation in height for half-level temperatures. True does linear interp using pressure. 
  ...
  integer   :: chunk_size = 4!16 !number of gridpoints to pass to socrates at a time
  ...
  REAL(r_def) :: o2_mix_ratio = 0.0 !0.2314
  REAL(r_def) :: so2_mix_ratio = 0.0
  REAL(r_def) :: cfc11_mix_ratio = 0.0 !1.110e-09
  REAL(r_def) :: cfc12_mix_ratio = 0.0 !2.187e-09
  REAL(r_def) :: cfc113_mix_ratio = 0.0 !4.826e-10
